...
irom void uart_write_char(uart_t* uart, char c)
{
...
irom void uart_write(uart_t* uart, const char* buf, size_t size)
{
    if(uart == NULL || !uart->tx_enabled) {
        return;
    }
...
irom int uart_read_char(uart_t* uart)
{
...
irom size_t uart_rx_available(uart_t* uart)
{
    if(uart == NULL || !uart->rx_enabled) {
        return -1;
    }
...
irom size_t uart_tx_free(uart_t* uart)
{
    if(uart == NULL || !uart->tx_enabled) {
        return 0;
    }
...
irom void uart_wait_tx_empty(uart_t* uart)
{
    if(uart == NULL || !uart->tx_enabled) {
        return;
    }
...
irom void uart_flush(uart_t* uart)
{
    if(uart == NULL) {
        return;
    }
...
irom void uart_set_baudrate(uart_t* uart, int baud_rate)
{
    if(uart == NULL) {
        return;
    }
...
irom int uart_get_baudrate(uart_t* uart)
{
    if(uart == NULL) {
        return 0;
    }
...
irom void uart_uninit(uart_t* uart)
{
    if(uart == NULL) {
        return;
    }
...
irom void uart_swap(uart_t* uart, int tx_pin)
{
    if(uart == NULL) {
        return;
    }
...
irom void uart_set_tx(uart_t* uart, int tx_pin)
{
    if(uart == NULL) {
        return;
    }
...
irom void uart_set_pins(uart_t* uart, int tx, int rx)
{
    if(uart == NULL) {
        return;
    }
...
irom bool uart_tx_enabled(uart_t* uart)
{
    if(uart == NULL) {
        return false;
    }
...
irom bool uart_rx_enabled(uart_t* uart)
{
    if(uart == NULL) {
        return false;
    }
...
irom static void uart_ignore_char(char c)
{
}

irom static void uart0_write_char(char c)
{
...
irom static void uart1_write_char(char c)
{
...
irom void uart_set_debug(int uart_nr)
{
